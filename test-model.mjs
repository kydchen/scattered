...
assert.match(html, /<script type="module" src="app\.js\?v=80"><\/script>/);
assert.match(app, /from "\.\/sync-model\.js\?v=79"/);
assert.match(app, /from "\.\/drive-sync\.js\?v=80"/);
...
assert.match(serviceWorker, /scattered-v80/);
assert.match(serviceWorker, /\.\/svg-export\.js\?v=75/);
assert.match(serviceWorker, /\.\/app\.js\?v=80/);
...
assert.match(serviceWorker, /\.\/drive-sync\.js\?v=80/);
