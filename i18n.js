export const messages = {
  en: {
    ...
    driveConflict: "Concurrent cloud changes were kept as {count} separate canvas copy/copies.",
    driveSyncFailed: "Google Drive sync paused. Local saving is still working.",
  ...
  "zh-Hans": {
    ...
    driveConflict: "检测到云端并发修改，已保留为 {count} 份独立画布副本",
    driveSyncFailed: "Google Drive 同步已暂停，本地保存仍正常工作",
