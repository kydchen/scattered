export const messages = {
  en: {
    ...
    restoreRecent: "Recovery copies",
    restoreCopy: "Restore {title} as a new canvas",
    recoveryEmpty: "No recovery copies yet",
    recoveryDeleted: "Before deletion",
    recoveryCleared: "Before clearing",
    recoveryReplaced: "Before replacement",
    ...
    driveOffline: "Offline. Changes are saved locally",
    driveAccountPending: "Account details unavailable",
    ...
    deleteTargetChanged: "The canvas changed. Select it again before deleting.",
    ...
    shareConsent: "Anyone with the link can view, not edit.",
    shareDetails: "Sharing details",
    shareNoticeUpdates: "Keep this browser open and online for updates. The last published version stays visible after you leave.",
    shareNoticeControls: "Manage this link here; link controls aren't synced with Google or exported.",
    shareNoticeStop: "Stop sharing before clearing site data. Saved copies can't be recalled.",
    shareLink: "Presentation link",
    shareEnable: "Enable sharing",
    shareCopy: "Copy link",
    sharePreview: "Open read-only preview",
    ...
    importBackup: "Import JSON as new canvases",
  ...
  "zh-Hans": {
    ...
    restoreRecent: "恢复副本",
    restoreCopy: "将 {title} 恢复为新画布",
    recoveryEmpty: "暂无可恢复的副本",
    recoveryDeleted: "删除前",
    recoveryCleared: "清空前",
    recoveryReplaced: "替换前",
    ...
    driveOffline: "当前离线，修改已保存在本地",
    driveAccountPending: "暂时无法读取账号信息",
    ...
    deleteTargetChanged: "当前画布已变化，请重新选择后再删除。",
    localBoards: "本地画布",
    ...
    shareTitle: "实时只读链接",
    shareConsent: "持链接者可只读查看。",
    shareDetails: "分享须知",
    shareNoticeUpdates: "此浏览器打开并联网时持续更新；离开后仍可查看最后发布的版本。",
    shareNoticeControls: "链接在此浏览器管理，管理权限不随 Google 同步或导出。",
    shareNoticeStop: "清除网站数据前先关闭分享；已保存的副本无法收回。",
    shareLink: "展示链接",
    shareEnable: "开启分享",
    shareCopy: "复制链接",
    sharePreview: "打开只读预览",
